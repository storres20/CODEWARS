...
function totalIncDec(x){
  //your code here
  let cont = BigInt(0); // contador de numeros Crecientes o Decrecientes
  let numBig = BigInt(Math.pow(10,x)); //numero maximo BigInt
  let num = Math.pow(10, x);
